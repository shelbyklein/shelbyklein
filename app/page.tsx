  ...
  return <div id="top">
    ...
    <main id="main">
      <section className="hero wrap" aria-labelledby="intro-title">
        ...
        <div className="hero-composition"><h1 id="intro-title">Design &<br/>creative<br/><span>technology.</span></h1><aside className="hero-aside"><span className="studio-note">Independent products<br/>& applications</span><div className="hero-objects"><Link href="/work/playcase" className="object-card"><img src="/images/playcase-card.png" alt="Explore PlayCase, my physical gaming product" width="600" height="600"/><span>PLAYCASE · PRODUCT DESIGN ↗</span></Link><Link href="/work/newton" className="object-mascot" aria-label="Explore Newton"><img src="/images/newton-logo.png" alt="Newton’s apple mascot" width="130" height="130"/></Link><span className="object-caption">NEWTON<br/>AI TEAM WORKSPACE</span></div></aside></div>
        <div className="hero-bottom"><p>I’m Shelby Klein, a designer and developer based in Orlando. My work spans brand identities, digital tools, physical products, and live experiences.</p><a className="round-link" href="#work"><span>Explore my work</span><span className="circle"><ArrowDown size={23}/></span></a></div>
        <div className="hero-foot"><span>BASED IN ORLANDO, FL</span><span>BRAND · DIGITAL · PRODUCT · MOTION</span></div>
      </section>
