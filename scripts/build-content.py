...
meta={
547:('playcase','PlayCase','A little nostalgia. A lot of real buttons.','Independent product',['Product design','3D printing','Brand & marketing'],'playcase-card.png','https://playcase.gg','PlayCase'),
660:('sea-education','Sea Education Association','Bringing ocean exploration to the web.','Client project',['Web design','Web development'],'sea-card.webp','https://sea.edu','Sea Education Association'),
550:('field-studies','The School for Field Studies','A digital home for learning in the field.','Client project',['Web design','Content architecture'],'sfs-card.webp','https://fieldstudies.org','School for Field Studies'),
1049:('usa-archery-broadcast','USA Archery Live','From the first arrow to the final broadcast.','National events',['Live production','Motion & software'],'usaa-livestream-screenshot.webp',None,'USA Archery'),
19:('steam-deck-hq','Steam Deck HQ','Building a home for handheld gaming.','Independent platform',['Brand identity','Web development'],'sdhq-cover-image.webp','https://steamdeckhq.com','Steam Deck HQ'),
549:('national-event-identities','National event identities','A shared identity. A new chapter, every year.','USA Archery',['Brand identity','Event design'],'logos-usaa-scaled.webp',None,'USA Archery'),
533:('olympic-jerseys','On the world’s biggest stage.','Team USA archery jerseys for Tokyo and Paris.','2020 & 2024 Olympic Games',['Apparel design','Creative direction'],'olympic-jersey-card.webp',None,'USA Archery'),
21:('workplace-solutions','Workplace Solutions','A fresh perspective on the places we work.','Client project',['Web design','Video & presentations'],'q2-stadium-suite.webp','https://wpsolutions.com','Workplace Solutions'),
114:('archery-is-for-everyone','Archery is for Everyone','An invitation to discover your inner archer.','USA Archery × Marvel',['Campaign direction','Film & design'],'Archery-is-for-Everyone.webp',None,'USA Archery, in collaboration with Marvel Entertainment'),
539:('us-open','U.S. Open Fan Experience','Turning spectators into participants.','2016 U.S. Open',['Interactive experience','Game development'],'us-open-fan-experience-7.jpg',None,'USTA'),
22:('sfs-brochure','SFS Recruitment Brochure','An invitation to take your education outside.','Client project',['Editorial design','Print production'],'SFS-Brochure-card.webp',None,'School for Field Studies'),
}
projects=[]
