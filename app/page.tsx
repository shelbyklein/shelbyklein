  ...
  return <ProjectPanelProvider projects={projects}><div id="top">
    ...
    <main id="main">
      <section className="hero wrap" aria-labelledby="intro-title">
        ...
        <div className="hero-composition"><h1 id="intro-title">Design &<br/>creative<br/><span>technology.</span></h1><aside className="hero-aside"><span className="studio-note">Independent products<br/>& applications</span><div className="hero-objects"><ProjectLink projectId="playcase" className="object-card"><img src="/images/playcase-card.png" alt="Explore PlayCase, my physical gaming product" width="600" height="600"/><span>PLAYCASE · PRODUCT DESIGN ↗</span></ProjectLink><ProjectLink projectId="newton" className="object-mascot" aria-label="Explore Newton"><img src="/images/newton-logo.png" alt="Newton’s apple mascot" width="130" height="130"/></ProjectLink><span className="object-caption">NEWTON<br/>AI TEAM WORKSPACE</span></div></aside></div>
