...
export function PrintHero() {
  ...
  return <section ref={root} className="collage-hero" aria-labelledby="intro-title"><HalftoneField density="sparse"/>
    <div className="collage-register wrap"><span>PORTFOLIO / SELECTED WORK, EXPERIMENTS & NOTES</span><span>ATLANTA, GEORGIA / OPEN TO THE UNEXPECTED</span></div>
    <div className="collage-hero-grid wrap"><PaperCollage scene="hero"/>
...
export function AtelierBand() {
  return <section className="band band--atelier" aria-labelledby="atelier-title"><HalftoneField density="sparse"/><PaperCollage scene="atelier"/><div className="atelier-band wrap"><div className="atelier-image"><MaskedCollage variant="poster" src="/images/flow/imagination-machine-code.png" alt="Brain, robot and code emblems linked by ribbons, gears and circuit traces"/></div><div className="atelier-copy" data-reveal><span className="cut-label">THE THREAD THROUGH IT ALL</span><h2 id="atelier-title">Different perspectives.<br/><em>Shared possibilities.</em></h2><p>Design gets more interesting when different minds meet. I bring the craft, curiosity, and technical know-how; you bring your world. Together, we can make something neither of us would have made alone.</p><a href="#work">Follow the thread <ArrowDown size={17}/></a></div></div></section>;
}
